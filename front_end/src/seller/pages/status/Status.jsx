      ...
      <div className="h-screen flex-1 p-7">
        ...
        <ol class="relative border-s border-gray-200 ">
          <li class="mb-10 ms-6">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 ">Flowbite Application UI v2.0.0 <span class="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded ms-3">Latest</span></h3>
