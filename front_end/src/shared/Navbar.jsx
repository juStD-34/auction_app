...
export default function NavbarUser() {
  ...
  return (
    <div>
    <div className="w-full h-30 p-5 bg-white border-t-2 border-b-2 border-gray grid grid-cols-10 gap-4">
        ...
        <div className="p-2 col-span-5 flex items-center">
            <div className="bg-gray-100 p-2 h-10 w-30 items-center hover:bg-gray-300 rounded-l-3xl">
                <Dropdown
                    arrowIcon={true}
                    inline
                    label={
            ...
            <div className='ml-0.5'>
                <input
                    placeholder="Search"
                    className="w-60 p-2 bg-gray-100 rounded-r-3xl"
                />
            </div>
            <div >
                <button className="ml-2 w-10 h-10 rounded-full border-2 border-gray-400 p-2 hover:bg-gray-300">
                    <img
                    src={search}
                    alt="dp"
                    />
        ...
        <div className="col-span-2 flex items-center justify-end mr-10">
            <div className="mr-2">
                <button className="items-center w-10 h-10 rounded-full border-2 border-gray-400 p-1 hover:bg-gray-300">
                    <img
                    src={noti}
            ...
            <div className="h-10 w-auto flex rounded-full border-2 border-gray-400 p-1 items-center space-x-2 pr-2 hover:bg-gray-300 rounded-full">
                <Dropdown
                    inline
                    placement="bottom"
                    label={
                        <button className="h-10 px-2 flex space-x-1 items-center justify-center focus:outline-none " >
                            <div className="h-8">
                                <img
        ...
        <div className="font-bold">
            <Navbar fluid rounded>
                <Dropdown
                    ...
                    placement="bottom"
                    label={
                    <p className="text-3xl ml-20 hover:text-red-500">Tài sản đấu giá</p>
                    }
                >
                    <Dropdown.Item>
                    <p className="hover:text-red-500">Tài sản nhà nước</p>
